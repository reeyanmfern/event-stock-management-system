...
export default function Inventory() {
  ...
  // Apply filters whenever products, searchTerm, selectedCategory, or stockFilter changes
  useEffect(() => {
  ...
  function exportToExcel() {
    ...
    // Prepare data for export (remove image_url and id columns)
    ...
    // Auto-size columns (optional - makes spreadsheet look better)
    const colWidths = [
      { wch: 25 }, // Product Name
      { wch: 15 }, // Category
      { wch: 12 }, // Size
      ...
      <div className="bg-white rounded-xl shadow-md p-6 mb-6">
        ...
        <div className="flex justify-between items-center mt-4">
          <div className="flex gap-2 text-sm">
            ...
            {lowStockCount > 0 && (
              <span className="text-orange-600">⚠️ {lowStockCount} low stock</span>
            )}
            {outOfStockCount > 0 && (
              ...
              <div className="p-6">
                <div className="flex justify-between items-start">
                  ...
                  {product.quantity < 10 && product.quantity > 0 && (
                    <span className="bg-orange-100 text-orange-700 text-xs px-2 py-1 rounded-full">Low Stock</span>
                  )}
                  {product.quantity === 0 && (
                ...
                <div className="mt-2 space-y-1">
                  ...
                  <p className="text-sm text-gray-600">
                    ...
                    <span className={`ml-1 font-bold ${
                      product.quantity < 10 && product.quantity > 0 ? 'text-orange-600' : 
            ...
            <div className="p-6">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-6">
                  ...
                  {formData.image_url && <div className="mt-2"><img src={formData.image_url} alt="Preview" className="w-32 h-32 object-cover rounded-lg" /></div>}
                  {uploading && <p className="text-sm text-blue-600 mt-1">Uploading...</p>}
                </div>
                <div className="flex space-x-3">
                  <button type="submit" className="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-lg flex-1" disabled={loading || uploading}>{loading ? 'Saving...' : 'Save'}</button>
